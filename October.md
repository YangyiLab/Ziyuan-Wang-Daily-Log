...
- [2021-10-30](#2021-10-30)
  ...
  - [微生物结果解读图](#微生物结果解读图)
    ...
    - [功能丰度](#功能丰度)
    - [附表](#附表)
  - [生成模型 generative model](#生成模型-generative-model)
    - [深度信念网](#深度信念网)
    - [深层玻兹曼机](#深层玻兹曼机)
- [2021-10-31](#2021-10-31)
  - [PLAN](#plan-14)
  - [利用化学结构推断电流科学问题](#利用化学结构推断电流科学问题)
    - [解决5mC](#解决5mc)
  - [PS修改](#ps修改)
    - [切入点](#切入点)
# 2021-10-1
...
加两行 共四行只需要去掉菠菜
### 物种堆叠图
不种菜的 16s和ITS拼一起放到附加文件
### beta多样性
不种菜的 三三比较两个 H1-F H2-F H3-F | H1-NF H2-NF H3-NF 拼到一起 放到附加文件
### 功能丰度
和 和Figure 4拼到一起
### 附表
添加上alpha多样性 和两两比较beta多样性的图 放到Table Supplemanry 2中

## 生成模型 generative model
### 深度信念网
顶层为限制玻兹曼机，其他层为有向连接贝叶斯网络
训练方法包括预训练和微调

### 深层玻兹曼机
遂层训练贪心算法 要考虑**自底向上和自顶向下，在层与层之间时需要考虑**
...
## 利用化学结构推断电流科学问题
### 解决5mC
通过正确预测含有 5-甲基胞嘧啶的 DNA 6mers 来概括从胸腺嘧啶到胞嘧啶的 5-甲基基团的化学信息，从而阐明核苷酸修饰的从头检测。

## PS修改
### 切入点
从高中开始，我们一直都被告诉，DNA是决定物种分化的关键。但最新研究表明，肠道细菌也能分化物种，DNA并非种群分离的唯一决定性因素。同时随着肠道微生物对人类健康影响被逐渐揭示，微生物让我感觉到不仅仅是培养皿的一个个菌落，在生物界中可以起到更大的作用。