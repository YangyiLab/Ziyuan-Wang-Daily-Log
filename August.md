...
- [2021-8-28/29](#2021-8-2829)
  - [PLAN](#plan-26)
  - [phage 4-class](#phage-4-class)
    - [RF AdaBoost](#rf-adaboost)
  - [论文修改-8/29](#论文修改-829)
  - [代谢组参考论文](#代谢组参考论文)
- [2021-8-30](#2021-8-30)
  - [PLAN](#plan-27)
...
## $K_a/K_s$ ratio
大于 1 的比率意味着积极的或达尔文选择（推动变化）；小于 1 意味着净化或稳定选择（反对变化）；比率正好为 1 表示中性（即没有）选择。
...
## QTL 数学原理 复合作图
在经典的复合区间作图定位中，采用了一个折中的方式，大体步骤如下：
